...
static const struct linear_range axp152_dcdc1_ranges[] = {
	LINEAR_RANGE(1700000, 0x0, 0x4, 100000),
	LINEAR_RANGE(2400000, 0x5, 0x9, 100000),
	LINEAR_RANGE(3000000, 0xa, 0xf, 100000),
};

static const struct linear_range axp152_aldo1_ranges[] = {
	LINEAR_RANGE(1200000, 0x0, 0x8, 100000),
	LINEAR_RANGE(2500000, 0x9, 0x9, 0),
	LINEAR_RANGE(2700000, 0xa, 0xb, 100000),
	LINEAR_RANGE(3000000, 0xc, 0xf, 100000),
};
...
static const struct linear_range axp152_ldo0_ranges[] = {
	LINEAR_RANGE(5000000, 0x0, 0x0, 0),
	LINEAR_RANGE(3300000, 0x1, 0x1, 0),
	LINEAR_RANGE(2800000, 0x2, 0x2, 0),
	LINEAR_RANGE(2500000, 0x3, 0x3, 0),
};
...
static const struct linear_range axp20x_ldo4_ranges[] = {
	LINEAR_RANGE(1250000, 0x0, 0x0, 0),
	LINEAR_RANGE(1300000, 0x1, 0x8, 100000),
	LINEAR_RANGE(2500000, 0x9, 0x9, 0),
	LINEAR_RANGE(2700000, 0xa, 0xb, 100000),
	LINEAR_RANGE(3000000, 0xc, 0xf, 100000),
};
...
static const struct linear_range axp806_dcdca_ranges[] = {
	LINEAR_RANGE(600000, 0x0, 0x32, 10000),
	LINEAR_RANGE(1120000, 0x33, 0x47, 20000),
};

static const struct linear_range axp806_dcdcd_ranges[] = {
	LINEAR_RANGE(600000, 0x0, 0x2d, 20000),
	LINEAR_RANGE(1600000, 0x2e, 0x3f, 100000),
};

static const struct linear_range axp806_cldo2_ranges[] = {
	LINEAR_RANGE(700000, 0x0, 0x1a, 100000),
	LINEAR_RANGE(3400000, 0x1b, 0x1f, 200000),
};
...
static const struct linear_range axp809_dcdc4_ranges[] = {
	LINEAR_RANGE(600000, 0x0, 0x2f, 20000),
	LINEAR_RANGE(1800000, 0x30, 0x38, 100000),
};
...
static const struct linear_range axp2101_dcdc2_ranges[] = {
	LINEAR_RANGE(500000, 0x0, 0x46, 10000),
	LINEAR_RANGE(1220000, 0x47, 0x57, 20000),
};

static const struct linear_range axp2101_dcdc3_ranges[] = {
	LINEAR_RANGE(500000, 0x0, 0x46, 10000),
	LINEAR_RANGE(1220000, 0x47, 0x57, 20000),
	LINEAR_RANGE(1600000, 0x58, 0x6a, 100000),
};

static const struct linear_range axp2101_dcdc4_ranges[] = {
	LINEAR_RANGE(500000, 0x0, 0x46, 10000),
	LINEAR_RANGE(1220000, 0x47, 0x66, 20000),
};

static const struct linear_range axp2101_rtcldo_ranges[] = {
	LINEAR_RANGE(1800000, 0x0, 0x0, 0),
	LINEAR_RANGE(2500000, 0x1, 0x1, 0),
	LINEAR_RANGE(2800000, 0x2, 0x2, 0),
	LINEAR_RANGE(3300000, 0x3, 0x3, 0),
};

static const struct linear_range axp2101_dcdc5_ranges[] = {
	LINEAR_RANGE(1400000, 0x0, 0x17, 100000),
	LINEAR_RANGE(1200000, 0x19, 0x19, 0),
};
...
static const struct linear_range axp858_dcdc5_ranges[] = {
	LINEAR_RANGE(800000, 0x0, 0x20, 10000),
	LINEAR_RANGE(1140000, 0x21, 0x44, 20000),
};
...
static const struct linear_range axp803_dcdc1_ranges[] = {
	LINEAR_RANGE(1600000, 0x0, 0x12, 100000),
};

static const struct linear_range axp803_dcdc2_ranges[] = {
	LINEAR_RANGE(500000, 0x0, 0x46, 10000),
	LINEAR_RANGE(1220000, 0x47, 0x4b, 20000),
};
...
static const struct linear_range axp803_aldo3_ranges[] = {
	LINEAR_RANGE(700000, 0x0, 0x1a, 100000),
	LINEAR_RANGE(3300000, 0x1b, 0x1f, 0),
};

static const struct linear_range axp803_dldo2_ranges[] = {
	LINEAR_RANGE(700000, 0x0, 0x1b, 100000),
	LINEAR_RANGE(3600000, 0x1c, 0x1f, 200000),
};
...
static struct linear_range axp2202_dcdc2_ranges[] = {
	LINEAR_RANGE(500000, 0, 0x46, 10000),
	LINEAR_RANGE(1220000, 0x47, 0x57, 20000),
	LINEAR_RANGE(1600000, 0x58, 0x6b, 100000),
};
