...
static u32 border_color = SUN8I_MIXER_BLEND_COLOR_BLACK;
			      ...
			      void *data)
{
	...
	/* Try to get a background color override for the border */
	mixer->border_color_ptr = &border_color;
...
module_param(border_color, uint, 0644);
