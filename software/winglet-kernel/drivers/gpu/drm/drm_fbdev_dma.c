					 ...
					 struct drm_fb_helper_surface_size *sizes)
{
	...
	buffer = drm_client_framebuffer_create2(client, sizes->surface_width,
...
void drm_fbdev_dma_setup2(struct drm_device *dev, unsigned int preferred_bpp,
	...
	if (override_w && override_h) {
		fb_helper->surface_override.fb_height = override_h;
		fb_helper->surface_override.fb_width = override_w;
		fb_helper->surface_override.surface_height = override_h;
		fb_helper->surface_override.surface_width = override_w;
		fb_helper->surface_override.fb_flags = override_flags;
		fb_helper->surface_override_en = true;
	}
...
EXPORT_SYMBOL(drm_fbdev_dma_setup2);

void drm_fbdev_dma_setup(struct drm_device *dev, unsigned int preferred_bpp)
{
	drm_fbdev_dma_setup2(dev, preferred_bpp, 0, 0, 0);
}
