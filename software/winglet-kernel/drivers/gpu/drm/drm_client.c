...
/**
 * drm_client_framebuffer_create2 - Create a client framebuffer with flags
 * @client: DRM client
 * @width: Framebuffer width
 * @height: Framebuffer height
 * @format: Buffer format
 * @flags: Flags to pass to the framebuffer create
 *
...
drm_client_framebuffer_create2(struct drm_client_dev *client, u32 width, u32 height, u32 format, u32 flags)
{
	struct drm_client_buffer *buffer;
	u32 handle;
	int ret;
	...
	ret = drm_client_buffer_addfb(buffer, width, height, format, handle, flags);
...
EXPORT_SYMBOL(drm_client_framebuffer_create2);
...
{
	return drm_client_framebuffer_create2(client, width, height, format, 0);
}
