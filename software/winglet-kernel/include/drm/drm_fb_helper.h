...
struct drm_fb_helper {
	...
	/**
	 * @screen_surface_override:
	 *
	 * Overrides the screen surface with a custom mode
	 */
	struct drm_fb_helper_surface_size surface_override;

	/**
	 * @surface_override_en:
	 *
	 * Uses the surface override set above
	 */
	bool surface_override_en;

	/**
	 * @screen_height:
	 *
	 * The actual screen height to be used by the crtc after scaling/moving
	 */
	u32 screen_height;
	 ...
	 * @screen_width:
	 *
	 * The actual screen width to be used by the crtc after scaling/moving
	 */
	u32 screen_width;
