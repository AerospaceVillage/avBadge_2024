			       ...
			       int argc, char *const argv[])
{
	...
	rc = device_bind_driver(usb_dev, "usb_dev_generic_drv", "ums_gadget", &umsdev_bind);
	if (rc) {
		pr_err("usb - not able to bind ums_gadget device: %d\n", rc);
		rc = CMD_RET_FAILURE;
		goto cleanup_ums_init;
	}
#endif
