...
#define CCM_PLL3_CTRL_N(n)		(((n) - 1) << CCM_PLL3_CTRL_N_SHIFT)
#define CCM_PLL3_CTRL_N_MASK	(0xFF << CCM_PLL3_CTRL_N_SHIFT)
#define CCM_PLL3_CTRL_DIV1(div1)	((div1) << 0)
#define CCM_PLL3_CTRL_DIV2(div0)	((div0) << 1)
#define CCM_PLL3_CTRL_DIV2_SHIFT	1
#define CCM_PLL3_CTRL_DIV2_MASK		(1 << 1)
...
#define CCM_DE2_CTRL_PLL3_4X		(1 << 24)
#define CCM_DE2_CTRL_PLL_VIDEO1_4X	(2 << 24)
#define CCM_DE2_CTRL_GATE		(0x1 << 31)

/* CCM bits common to all TCON LCD clock ctrl regs */
#define CCM_TCONLCD_CTRL_M(n)		((((n) - 1) & 0xf) << 0)
#define CCM_TCONLCD_CTRL_PLL_MASK		(3 << 24)
#define CCM_TCONLCD_CTRL_PLL3_1X		(0 << 24)
#define CCM_TCONLCD_CTRL_PLL3_4X		(1 << 24)
#define CCM_TCONLCD_CTRL_PLL_VIDEO1_1X	(2 << 24)
#define CCM_TCONLCD_CTRL_PLL_VIDEO1_4X	(3 << 24)
#define CCM_TCONLCD_CTRL_GATE		(0x1 << 31)
