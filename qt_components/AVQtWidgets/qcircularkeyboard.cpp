#include "qcircularkeyboard.h"

#include <QLabel>
#include <QKeyEvent>
#include <cmath>

QCircularKeyboard::QCircularKeyboard(QList<QChar> keyboard_characters, QWidget* parent, QString text, QString highlight_text) {
...
QCircularKeyboard::~QCircularKeyboard() {
    for (int i=0; i<this->character_widgets.size(); i++) {
        delete this->character_widgets[i];
    }
}

bool QCircularKeyboard::eventFilter(QObject *obj, QEvent *event) {
...
void QCircularKeyboard::onEntrySelectionLeft() {
...
void QCircularKeyboard::onEntrySelectionRight() {
    this->last_selected_entry_index = this->selected_entry_index;
    this->last_selected_entry = this->character_widgets[this->last_selected_entry_index];
...
void QCircularKeyboard::onEntrySelectionConfirm() {
