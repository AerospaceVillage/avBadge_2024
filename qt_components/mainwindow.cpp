...
//    getdata->start();
    ...
    oScope_entry->set_return_to(rotary_menu);
    splash_entry->set_return_to(rotary_menu);
    flightBoard_entry->set_return_to(rotary_menu);
    radarscope_entry->set_return_to(rotary_menu);
    mediaplayer_entry->set_return_to(rotary_menu);
